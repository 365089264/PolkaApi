...
CREATE  TABLE `tb_pool_token` (
    ...
    tokenName           varchar(100) NOT NULL                                comment '代币名称',
    poolID              varchar(60) NOT NULL                                comment '池子ID',
...
CREATE  TABLE `tb_tokenPrice` (
    ...
    decimals            int(10) NOT NULL                                    comment '代币小数',
    precisions           int(10) NOT NULL                                    comment '代币精度',
    price               decimal(20,10)  NOT NULL                            comment '代币的usd价值',
    color               varchar(10) NOT NULL                                comment '颜色',
    hasIcon             tinyint(1) NOT NULL DEFAULT 1                       comment '0-无 1-有',
    logoURL             varchar(200) NOT NULL                               comment 'logo地址',
    createdAt           timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP        comment '创建时间'
)ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
